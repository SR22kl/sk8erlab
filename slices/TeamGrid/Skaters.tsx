...
export function Skaters({ skater, index }: Props) {
  const colors = [
    "text-brand-blue",
    "text-brand-lime",
    "text-brand-orange",
    ...
    <>
      <div className="skater group relative flex flex-col items-center gap-4">
        <div className="stack-layout overflow-hidden">
          ...
          <h3 className="relative grid place-self-end justify-self-center p-2 font-heading text-brand-gray text-[clamp(1.5rem,1.34rem+0.8vw,1.875rem)] z-30">
